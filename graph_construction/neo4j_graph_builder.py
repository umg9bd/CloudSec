...
# privilege_features.py lives one directory up from this file: this module
# is in graph_construction/, and privilege_features.py is in its parent
# directory. Since this file is invoked directly as a script
# (`python3 neo4j_graph_builder.py`), package-relative imports aren't
# available, so the parent directory is added to sys.path explicitly
# before importing.
